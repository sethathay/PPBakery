...
class ReportsController extends Controller
{
	...
	public function selectReport(Request $request, SaleOrderReportAjax $saleOrder){
		...
		$columns   = array('sales_orders.id','sales_order_receipts.created_at', 'first_name', 'receipt_code', 'discount_riel', 'discount_us', 'amount_kh', 'amount_us', 'IF(sales_orders.balance>0,sales_orders.balance,0)');
