		...
		<div class="col-sm-5">
        	<div class="form-group">
                <div class='input-group'>
					<img src="{{ URL::asset('/img/receipt_b.png') }}" /> <label> របាយការណ៍ តាមក្រុមចំនាយ</label>
                </div>
            </div>
		</div>
	...
	jQuery(document).ready(function(){
		...
		$(".btn-success").click(function(){						
			if($('#date_from').val() == "" || $("#date_to").val() == ""){
				...
				var sectionGroup = "<?php echo implode(',', $arrSectionGroup);?>";
				$.ajax({
					url : 'selectReportByGroupExpense',
					type: 'POST',
					data: { dateFrom : dateFrom, dateTo : dateTo, sectionGroup: sectionGroup, _token : "{!! csrf_token() !!}"},
