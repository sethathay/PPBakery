<div class="navbar col-md-2 left_menu">
    <div class="navbar-inner">
        <ul class="nav">
			...
			<li onclick="redirectPage('/orders/index')"><img src="{{ URL::asset('img/house_sale.png') }}" alt="order" /> &nbsp;&nbsp;<label style="vertical-align: middle;font-weight: normal;">Sales</label></li>
			...
			<li onclick="redirectPage('/users/index')"><img src="{{ URL::asset('img/users_2.png') }}" alt="Users" /> &nbsp;&nbsp;<label style="vertical-align: middle;font-weight: normal;">Users</label></li>
