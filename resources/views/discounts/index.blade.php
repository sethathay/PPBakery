...
<div class="table-responsive table-list">
	<div class="col-sm-12 panel-heading">
		...
		<div class="col-sm-5"
			...
			<button onclick="redirectPage('discounts/create')" type="button"
	...
	@endif
	<table class="table table-hover table-bordered table-striped" id="tbl_discount">
		<thead>
			<tr>
				<th>ឈ្មោះ</th>
				<th>ចំនួន</th>
...
<script type="text/javascript">
	...
	var table = $('#tbl_discount').DataTable( {

        "data": <?php echo $discounts ?>,
        "order": [[ 4, "desc" ]],
	...
	$('#tbl_discount tbody').on( 'click', '.btnview', function () {
        var data = table.row( $(this).parents('tr') ).data();
        redirectPage('discounts/' + data['id']);
    } );

    $('#tbl_discount tbody').on( 'click', '.btnedit', function () {
        var data = table.row( $(this).parents('tr') ).data();
        redirectPage('discounts/' + data['id'] + '/edit');
    } );

    $('#tbl_discount tbody').on( 'click', '.btndelete', function () {
        var data = table.row( $(this).parents('tr') ).data();
        var ts = $(this);
