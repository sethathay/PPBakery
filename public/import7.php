...
//$source = ("http://192.168.0.133/PPbakery/public/db_backup/db-backup-".date('Y-m-d')."-7.sql");
$source = ("http://119.82.252.32:53210/db_backup/db-backup-".date('Y-m-d')."-7.sql");

$saveFile = $dir."db-backup-".date('Y-m-d')."-7.sql";
