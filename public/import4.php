...
//$source = ("http://192.168.0.133/PPbakery/public/db_backup/db-backup-".date('Y-m-d')."-4.sql");
$source = ("http://119.82.252.32:53210/db_backup/db-backup-".date('Y-m-d')."-4.sql");

$saveFile = $dir."db-backup-".date('Y-m-d')."-4.sql";
