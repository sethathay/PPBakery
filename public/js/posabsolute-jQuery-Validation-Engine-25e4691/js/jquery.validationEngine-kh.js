    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "min": {
                    "regex": "none",
                    "alertText": "* បញ្ចូលយ៉ាងតិច "
                },
                "max": {
                    "regex": "none",
                    "alertText": "* បញ្ចូលយ៉ាងច្រើន "
                },
                "past": {
                    "regex": "none",
                ...
                "equals": {
                    "regex": "none",
                    "alertText": "* ទិន្នន័យមិនដូចគ្នា"
                },
                "phone": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^([\+][0-9]{1,3}[ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9 \.\-\/]{3,20})((x|ext|extension)[ ]?[0-9]{1,4})?$/,
                    "alertText": "* លេខទូរសព្ទ័មិនត្រឹមត្រូវ"
                },
                "email": {
                    // Simplified, was not working in the Iphone browser
                    "regex": /^([A-Za-z0-9_\-\.\'])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,6})$/,
                    "alertText": "* អ៊ីម៉េលមិនត្រឹមត្រូវ"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                    "alertText": "* សូមបញ្ចូលចំនួនគត់"
                },
                "number": {
                    // Number, including positive, negative, and floating decimal. credit: orefalo
                    "regex": /^[\-\+]?(([0-9]+)([\.,]([0-9]+))?|([\.,]([0-9]+))?)$/,
                    "alertText": "* សូមបញ្ចូលលេខ"
                },
                "date": {
                    // Date in ISO format. Credit: bassistance
                    "regex": /^\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2}$/,
                    "alertText": "* បញ្ជូលមិនទំរង់៖ YYYY-MM-DD"
                },
                "ipv4": {
                ...
                "ajaxUserCall": {
                    ...
                    "alertTextLoad": "* កំពុងផ្ទៀងផ្ទាត់, សូមរង់ចាំ"
                },
                "ajaxUserCall2": {
